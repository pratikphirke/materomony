...
export class Brother5Page {
  ...
  ionViewDidLoad() {
    ...
    this.Brother4info = this.navParams.get('Brother4info');
    console.log('--Brother4info---',this.Brother4info);
  }
