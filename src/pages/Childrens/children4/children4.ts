...
import { Children5Page } from '../children5/children5';


//@IonicPage()
@Component({
  selector: 'page-children4',
  templateUrl: 'children4.html',
})
export class Children4Page {
    ...
    SaveChildrensInfo(data: any) {
        ...
        if (this.register.valid) {
          ...
          ///  formdata.append('', this.dataStepOne);
            ...
            if(this.SelectedChildCount >='5'){
           //   console.log(' EQUAL go to next SELECTED BRO',this.SelectedBroCount)
              this.navCtrl.push(Children5Page, {Child1Info: data,SelectedChildCount: this.SelectedChildCount});
      
            }else if(this.SelectedChildCount=='4'){
