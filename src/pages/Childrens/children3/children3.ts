...
import { Children4Page } from '../children4/children4';


//@IonicPage()
@Component({
  selector: 'page-children3',
  templateUrl: 'children3.html',
})
export class Children3Page {
  register: FormGroup;
    ...
    SaveChildrensInfo(data: any) {
        ...
        if (this.register.valid) {
          ...
          ///  formdata.append('', this.dataStepOne);
            ...
            if(this.SelectedChildCount >='4'){
           //   console.log(' EQUAL go to next SELECTED BRO',this.SelectedBroCount)
              this.navCtrl.push(Children4Page, {Child1Info: data,SelectedChildCount: this.SelectedChildCount});
      
            }else if(this.SelectedChildCount=='3'){
